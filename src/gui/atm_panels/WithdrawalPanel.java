...
public class WithdrawalPanel extends Panel {
    ...
    public WithdrawalPanel(Connection conn, String logged_in_customer_id) {
        this.conn = conn;
    ...
    public void handleSubmit() throws SQLException {
        ...
        TransactionFactory.createWithdrawal(
                conn,
                amount,
    ...
    public static void openWithdrawalDialog(Connection conn, String logged_in_customer_id) {
        WithdrawalPanel withdrawal_pane = new WithdrawalPanel(conn, logged_in_customer_id);
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                withdrawal_pane.handleSubmit();
                conn.commit();
                JOptionPane.showMessageDialog(null, "Successfully withdrew money.");
            } catch (SQLException se) {
                se.printStackTrace();
                JDBCConnectionManager.rollbackConn(conn);
                JOptionPane.showMessageDialog(null, "Something went wrong when withdrew money from this account.");
            }
        }
    }
}